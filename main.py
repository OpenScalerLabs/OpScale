...
def main() -> None:
    ...
    # 2. Eingabevideo
    videos = [p for p in input_dir.iterdir() if p.suffix.lower() in (".mp4", ".mkv", ".avi", ".mov")]
    if not videos:
        print_error(
    ...
    # 5. Pipeline initialisieren & Konfiguration ausgeben
    try:
        ...
        output_filename = f"{selected_video.stem}_{selected_model.stem}_{scale_val}x.mp4"
